...
/// @title BLOOPS Locations Contract v1.3
/// @author Matto
/// @notice This contract determines where (almost) everything is placed in the final image.
...
contract BLOOPSlocations {
    ...
    returns (uint16[110] memory)
  {
    ...
    eO /= 10;
    loc[2] = (1000 - loc[4]) - 3 * (1000 - loc[4]) / 20; 
    loc[3] = 2 * (1000 - loc[5]) / 3 ; 
    ...
    eO /= 10;
    loc[6] = loc[2] - 80 + (loc[4] / 2 - loc[8]) - eM(eO,10) * 4;
    eO /= 10;
    ...
    // Nose
    eO /= 10;
    loc[26] = (loc[10] - (loc[6] + loc[8])) / 3;
    loc[27] = loc[5] / 8 + eM(eO,10) * 4;
    eO /= 10;
    loc[24] = p(loc[2] + (loc[4] - loc[26]) / 2, eO, 5) - loc[26] - 20;
    eO /= 10;
    ...
    eO /= 10;
    loc[28] = loc[2] - loc[31] < loc[3] + 15 ? 15 : loc[2] - loc[31] - loc[3];
    loc[29] = loc[2] + loc[4] < loc[31] ? 0 : loc[2] + loc[4] - loc[31];
    ...
    eO /= 10;
    loc[38] = loc[7] - 6 - loc[40] - eM(eO,10) * 4 - loc[40] * 3;
    eO /= 10;
    ...
    eO /= 10;
    loc[42] = loc[11] - 6 - loc[44] - eM(eO,10) * 4 - loc[44] * 3;
    ...
    if (eM(eO,10) < 2) { 
      eO /= 10;
      if (eM(eO,10) < 5) {
        loc[45] = loc[2] + loc[27] + loc[27] / 2 - eM(eO,10) * 4 - loc[27];
      } else {
        loc[45] = loc[2] + loc[4] - loc[27] - loc[27] / 2  + eM(eO,10) * 4 - loc[27];
      }
      eO /= 10;
    ...
    if (tA[3] == 1) {
      ...
      loc[54] = 1150 - (loc[2] + loc[4] - (loc[2] + loc[4] - (loc[10] + loc[12])) / 2);
      loc[55] = loc[11] - loc[13];
      loc[59] = loc[55] + loc[57] + 15; 
      loc[60] = 2 * loc[56];
    ...
    if (tA[4] != 0) {
      ...
      loc[68] = loc[24] + loc[26] + 80;
      loc[69] = loc[28] + (loc[66] - loc[28]) / 4;
      loc[70] = loc[30] - 100;
      loc[71] = loc[67] / 2;
      loc[72] = loc[24] + loc[26] + loc[47] + 90;
      loc[73] = loc[30] - 100;
      loc[74] = (loc[29] + loc[31] - loc[24] - loc[26] - loc[47])/2;

      loc[62] = (loc[66] + loc[68]) / 2;
      loc[63] = loc[25] - 23;
      loc[64] = loc[26];
      loc[65] = 20;
    }
    ...
    if (tA[5] == 1) {
      loc[78] = (loc[30] - loc[3]);
      loc[75] = loc[2] - 20;
      loc[76] = loc[3] - loc[78] / 2 < 150 ? 0 : loc[3] - loc[78] / 2 - 150;
      loc[77] = loc[4] + 60;
    } else if (tA[5] == 2) {
      loc[78] = (loc[30] - loc[3]) / 2 + 120;
      loc[75] = loc[2] + loc[31] / 2 - 40;
      loc[76] = loc[3] - loc[78] - 40;
      loc[77] = loc[4] - loc[31] + 20;
    } else if (tA[5] == 3) {
      loc[78] = (loc[30] - loc[3]) / 2 + 120;
      loc[75] = loc[2] + loc[31] / 2 - 40;
      loc[76] = loc[3] - loc[78] - 40;
      loc[77] = loc[4] - loc[31] + 20;
      loc[82] = loc[78] * 2;
      loc[79] = loc[2] + loc[4] / 6 < 300 ? 0 : loc[2] + loc[4] / 6 - 300;
      loc[80] = loc[3] + 80 < loc[82] ? 0 : loc[3] + 80 - loc[82];
      loc[81] = loc[4] / 2;
    } else if (tA[5] == 4) {
    ...
    if (tA[6] > 0) {
      loc[89] = loc[4] + 40;
      loc[90] = (loc[30] - loc[3]) / 3 + 20;
      loc[87] = loc[2] - 20;
      loc[88] = loc[3] + loc[90] / 2 < 150 ? 0 : loc[3] + loc[90] / 2 - 150;
    } 
    if (tA[6] == 2) {
      loc[91] = loc[88] + loc[90] / 5 - 18;
      loc[92] = (3 * loc[90]) / 5;
    }
    if (tA[5] == 3) {
      loc[83] = loc[2] < 400 ? 0 : loc[2] - 400;
      loc[84] = loc[3] - 2;
      loc[85] = loc[31];
      loc[86] = (3 * loc[5]) / 4  < eM(eT,10) * 7 ? 0 : (3 * loc[5]) / 4 - eM(eT,10) * 7;
    }
    ...
    if (tA[9] == 0) {
      ...
      loc[98] = loc[2] - loc[27] / 2 + 100;
      loc[99] = loc[3] + loc[5];
      loc[100] = loc[4] + loc[27] < 300 ? 0 : loc[4] + loc[27] - 300;
      loc[101] = loc[27];
      loc[104] = loc[27] / 2;
      loc[103] = loc[32] + loc[30] + 50;
      loc[105] = loc[3] + loc[5] - loc[103] + 10;
      loc[102] = loc[2] - loc[104] - loc[98] / 2 + loc[101];
      loc[97] = loc[2] + loc[4];
      ...
      loc[99] = loc[3] + loc[5] + loc[19] + 50;
      loc[98] = loc[0] - 5;
      loc[100] = loc[1] + 80;
      loc[101] = 1000 - loc[99] + 20;
    } else if (tA[9] == 5) {
      loc[98] = loc[0] - 50;
      loc[99] = 1000 - loc[27] + 40;
      loc[100] = loc[1] + 120;
      loc[101] = loc[27];
      loc[102] = loc[98] + 30;
      loc[104] = loc[100] - 60;
