...
/// @title BLOOPS Locations Contract v1.1
/// @author Matto
...
contract BLOOPSlocations {
    ...
    returns (uint16[110] memory)
  {
    ...
    eO /= 10;
   loc[28] = loc[2] - loc[31] - loc[3];
   loc[29] = loc[2] + loc[4] - loc[31];
    ...
    if (tA[5] == 1) {
      ...
      loc[77] = loc[4] - loc[31] + 20;
      loc[82] = loc[78] * 2;
      loc[79] = loc[2] + loc[4] / 6 - 300;
      loc[80] = loc[3] - loc[82] + 80;
      loc[81] = loc[4] / 2;
    } else if (tA[5] == 4) {
